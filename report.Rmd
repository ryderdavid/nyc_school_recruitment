...
counts_by_geog <- function (points = NULL, geography = NULL, yearmin = 0, yearmax = 10000) {
  ...
  geog <- geography
  yr <- seq(yearmin, yearmax)
  pts <- points %>% filter(year %in% yr)
...
apps.2017.sd <- counts_by_geog(application_points, nyc_sds, 2017, 2017)
apps.2017.ntas <- counts_by_geog(application_points, nyc_ntas, 2017, 2017)
apps.2017.tracts <- counts_by_geog(application_points, nyc_tracts, 2017, 2017)

apps.2018.sd <- counts_by_geog(application_points, nyc_sds, 2018, 2018)
apps.2018.tracts <- counts_by_geog(application_points, nyc_tracts, 2018, 2018)

apps.2019.sd <- counts_by_geog(application_points, nyc_sds, 2019, 2019)
apps.2019.tracts <- counts_by_geog(application_points, nyc_tracts, 2019, 2019)

regs.2017.tracts <- counts_by_geog(registration_points, nyc_tracts, 2017, 2017)
regs.2018.tracts <- counts_by_geog(registration_points, nyc_tracts, 2018, 2018)


apps.tracts <- counts_by_geog(recruitment_data, nyc_tracts)
...
tmap_mode("view")
tmap_arrange(a2017.tracts, a2018.tracts, a2019.tracts, ncol = 3, sync = T, asp = 1)
...
tmap_mode("view")
tmap_arrange(r2017.tracts, r2018.tracts, ncol = 2, sync = T)
