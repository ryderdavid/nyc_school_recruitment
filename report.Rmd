...
# 
# 
# install.packages(c('here', 'sf', 'raster', 'devtools', 'acs', 'tidycensus', 
#                    'tidyverse', 'tigris', 'sp', 'tmap', 'tmaptools', 'readxl', 
#                    'ggplot2', 'rgdal', 'spdplyr', 'RColorBrewer', 'viridis', 
#                    'viridisLite', 'rstudioapi', 'magrittr', 'getPass', 
#                    "kableExtra", 'rmarkdown', "revgeo"))
...
download.file(url = "https://data.cityofnewyork.us/api/views/jfju-ynrr/files/IjLvNcAZDM01muXoNu_-a2ggw13oNeeV4xH-rPS_Dig?filename=Public_School_Locations.zip",
              destfile = "data/downloads/school_points.zip")
