...
sheet_1 <- read_xlsx("schooldata/historical_recruitment_data.xlsx", sheet = 1)
sheet_2 <- read_xlsx("schooldata/historical_recruitment_data.xlsx", sheet = 2)
sheet_3 <- read_xlsx("schooldata/historical_recruitment_data.xlsx", sheet = 3)
...
### To reach target recruitment systemwide

Though

```{r, to_reach_target_recruitment}
...
recruitment_data %>% 
  ...
  kable(., caption = "To reach target enrollment") %>% 
  kable_styling(bootstrap_options = "striped")
